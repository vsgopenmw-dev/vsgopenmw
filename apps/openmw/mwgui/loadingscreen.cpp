...
namespace MWGui
{
        ...
        : WindowBase("openmw_loading_screen.layout")
    {
        ...
        mProgressBar->setScrollRange(1000);
    ...
    void LoadingScreen::update(float complete, float dt, bool showWallpaper)
    {
        ...
        if (showWallpaper)
        {
            ...
            if (!mSplashScreens.empty() && mChangeWallpaperCountdown <= 0)
            {
                ...
                // we can't do this by default, because the Morrowind splash screens are 1024x1024, but should be
                // displayed as 4:3
        ...
        mProgressBar->setTrackSize(complete * (mProgressBar->getLineSize()-1));
    }
}
