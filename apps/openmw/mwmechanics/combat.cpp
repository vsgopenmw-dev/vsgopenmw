...
namespace MWMechanics
{
        ...
        const osg::Quat& orient)
    {
        ...
        MWBase::Environment::get().getWorld()->launchProjectile(
            actor, weapon, launchPos, orient, weapon, speed, attackStrength);
    }
        ...
        const osg::Vec3f launchPos, const osg::Quat& orient)
    {
        ...
        MWBase::Environment::get().getWorld()->launchProjectile(
            actor, ammo, launchPos, orient, weapon, speed, attackStrength);
    }
        ...
        float damage, float attackStrength)
    {
        ...
        float angleDegrees = osg::RadiansToDegrees(signedAngleRadians(
            ...
            MWAnim::forward(blocker.getRefData().getPosition()), { 0, 0, 1 }));
