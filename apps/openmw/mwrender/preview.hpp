...
namespace MWRender
{
    ...
    public:
        Preview(vsg::Context& ctx, VkSampleCountFlagBits samples, const MWAnim::Context& in_animContext, Resource::ResourceSystem* resourceSystem);
        ~Preview();
    ...
    protected:
        ...
        vsg::vec3 mLightPos;
        vsg::ref_ptr<vsg::Group> mSceneGraph;
