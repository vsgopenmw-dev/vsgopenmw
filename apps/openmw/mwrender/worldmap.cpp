...
namespace MWRender
{
    ...
    class WorldMap::UpdateOverlay : public Render::ComputeImage
    {
        ...
        mutable vsgUtil::DeletionQueue mDeletionQueue = vsgUtil::DeletionQueue(3);
    ...
    public:
        ...
        void accept(vsg::RecordTraversal& visitor) const override
        {
            ...
            for (auto& r : requests)
            {
                ...
                compute(visitor, r.image, r.dstRect.z - r.dstRect.x, r.dstRect.w - r.dstRect.y);
    ...
    void WorldMap::load(const MWWorld::ESMStore& esmStore, int cellSize)
    {
        ...
        overlayImage->format = Render::compatibleColorFormat;
        overlayImage->arrayLayers = 1;
        overlayImage->mipLevels = 1;
        overlayImage->usage = VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT
