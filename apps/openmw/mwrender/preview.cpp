...
{
    Preview::Preview(
        vsg::Context& ctx, const MWAnim::Context& in_animContext, Resource::ResourceSystem* resourceSystem)
    {
        ...
        mView->mask = ~Mask_GUI;
        mView->bins
            = { vsg::Bin::create(Bin_DepthSorted, vsg::Bin::DESCENDING), vsgUtil::NullBin::create(Bin_Compute) };
