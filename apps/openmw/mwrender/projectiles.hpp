...
namespace MWRender
{
    ...
    public:
        ...
        std::shared_ptr<ProjectileHandle> add(const std::string& model, const vsg::vec3& pos, const vsg::quat& orient,
            bool autoRotate, std::optional<vsg::vec3> lightColor, std::optional<vsg::vec4> glowColor,
            const std::string textureOverride, const std::vector<std::string> additionalModels);
