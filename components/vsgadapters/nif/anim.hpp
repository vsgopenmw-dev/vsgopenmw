...
namespace vsgAdapters
{
        ...
        const Nif::Controller& ctrl, Anim::channel_ptr<T>& channel, float startKey, float stopKey)
    {
        ...
        if (ctrl.frequency == 1 && ctrl.phase == 0 && mode == Anim::ExtrapolationMode::Constant && ctrl.timeStart <= startKey
            && ctrl.timeStop >= stopKey)
            return;
        ...
        Anim::ExtrapolationSettings settings{ ctrl.frequency, ctrl.phase, ctrl.timeStart, ctrl.timeStop };
