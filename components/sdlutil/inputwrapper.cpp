...
namespace SDLUtil
{
    ...
    void InputWrapper::updateMouseSettings()
    {
        ...
        // eep, wrap the pointer manually if the input driver doesn't support relative positioning natively
        // also use wrapping if no-grab was specified in options (SDL_SetRelativeMouseMode  appears to eat the mouse
        // cursor when pausing in a debugger)
