...
namespace vsgUtil
{
    ...
    vsg::ref_ptr<T> searchFirst(vsg::Object& o)
    {
        return Search<T, Base, false, true>().search(o);
    }
    ...
    vsg::ref_ptr<T> search(vsg::Object& o)
    {
        return Search<T, Base, true, true>().search(o);
    }
     ...
     */
    template <class T, class Base = Traverse>
    vsg::ref_ptr<T> findFirst(vsg::Object& o)
    {
        return Search<T, Base, false, false>().search(o);
    }
     ...
     */
    template <class T, class Base = Traverse>
    vsg::ref_ptr<T> find(vsg::Object& o)
    {
        return Search<T, Base, true, false>().search(o);
    }
}
