...
namespace vsgUtil
{
    ...
    public:
        ...
        void apply(vsg::DepthSorted&) override {}
    ...
    {
        vsgUtil::AccumulatePath<vsg::Transform*> mTransformPath;
    ...
    public:
        ...
        void setRequiresLocalFrustum()
        {
            if (!mTransformPath.path.empty())
                mTransformPath.path.back()->subgraphRequiresLocalFrustum = true;
        }
        void apply(vsg::DepthSorted& node) override
        {
            setRequiresLocalFrustum();
        }
        ...
        {
            auto ppn = mTransformPath.pushPop(&t);
            applyGroup(t);
        }
        void apply(vsg::StateGroup& group) override
        {
