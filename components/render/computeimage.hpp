...
namespace Render
{
    ...
    protected:
        ...
        vsg::ref_ptr<vsg::ClearColorImage> mClearColorImage;
        ...
        void compute(vsg::RecordTraversal& visitor, vsg::ref_ptr<vsg::Image> image, uint32_t w, uint32_t h, uint32_t workGroupSize) const;
