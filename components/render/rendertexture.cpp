...
namespace Render
{
    vsg::ref_ptr<vsg::RenderGraph> createRenderTexture(vsg::Context& context, const VkExtent2D& extent,
        vsg::ref_ptr<vsg::ImageView>& colorImageView, int usage, VkImageLayout finalColorLayout)
    {
        ...
        rendergraph->framebuffer = vsg::Framebuffer::create(
            ...
            vsg::ImageViews{ colorImageView, depthImageView }, extent.width, extent.height, 1);
        return rendergraph;
    }
}
